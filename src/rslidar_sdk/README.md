...
## 0 Connection of LiDAR to computer

The sensor has set the default IP address to computer at factory, therefore, the default
IP address of the computer should be set as 192.168.1.102, sub-net mask as
255.255.255.0
